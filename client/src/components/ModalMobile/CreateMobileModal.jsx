...
const CreateModal = ({
  ...
  const handleSubmit = async () => {
    ...
    // * Send to Server
    await fetch(`${process.env.REACT_APP_BASE_URL}/mobiles`, {
      method: "POST",
      headers: {
                ...
                : 
                  ...
                  >
                    ...
                    >
                      <ArrowUpwardOutlined className='w-5 h-5 fill-current' />
                      {isDragActive ? (
                        <p className='xx:text-xs'>
                          Drop the files here ...
                        </p>
                      ) : (
                        <p className='xx:text-xs lg:text-base'>
