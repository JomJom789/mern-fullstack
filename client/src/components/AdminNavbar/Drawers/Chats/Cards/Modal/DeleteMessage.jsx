...
/*                                DeleteMessage                               */
/* -------------------------------------------------------------------------- */
const DeleteMessage = ({isOpen, setIsOpen, chatId, messageId, setMessages}) => {
  ...
  const handleDelete= async () => {
    try {
      ...
      // * Fetch
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/message/delete/${_id}/${chatId}/${messageId}`, {
        method: "DELETE",
        headers: {
