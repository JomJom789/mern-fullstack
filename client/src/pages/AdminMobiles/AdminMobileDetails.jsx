...
const AdminMobileDetails = () => {
  ...
  const handleSubmit = async () => {
    ...
    // * Send to Server
    await fetch(`${process.env.REACT_APP_BASE_URL}/mobiles/${id}/update`, {
      method: "PATCH",
      headers: {
  ...
  const handleDelete = async () => {    
    ...
    // * Send to Server    
    await fetch(`${process.env.REACT_APP_BASE_URL}/mobiles/${id}/delete`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,        
      },
                        ...
                        <input {...getInputProps()} />
                        {
                          ...
                          : (
                              <div className='relative'>
                                <img
                                  key={imgCoverDb}
                                  src={imgCoverDb ? `${process.env.REACT_APP_BASE_URL}/mobiles/${imgCoverDb}` : ``}
                                  alt={imgCoverDb}
                                  width={100}
                                  height={100}
                ...
                >
                  ...
                  }
                  {
                    ...
                    imagesDb.map(file => (
                      ...
                      >
                        <img
                          src={imagesDb ? `${process.env.REACT_APP_BASE_URL}/mobiles/${file}` : ``}
                          alt={file}
                          width={100}
                          height={100}
                          onLoad={() => {
